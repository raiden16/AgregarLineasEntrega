...
Public Class FrmtekSch
    ...
    Public Function openForm(ByVal psDirectory As String)
        ...
        Try
            ...
            coForm = cSBOApplication.Forms.Item("tekSearchDev")
            coForm.DataSources.UserDataSources.Item("dsUsers").Value = ""
            coForm.DataSources.UserDataSources.Item("dsDates").Value = ""
            coForm.DataSources.UserDataSources.Item("dsTrucks").Value = ""

            'stQueryH = "Select count(""Code"")+1 as ""DocEntry"" from ""@EP_EN0"""
            'oRecSetH.DoQuery(stQueryH)

            coForm.DataSources.UserDataSources.Item("dsDocNs").Value = ""

            coForm.Items.Item("4").Enabled = False
            coForm.Items.Item("7").Enabled = False
            coForm.Items.Item("8").Enabled = False
    ...
    Private Function bindUserDataSources() As Integer
        ...
        Try
            ...
            loDS = coForm.DataSources.UserDataSources.Add("dsDrivers", SAPbouiCOM.BoDataType.dt_SHORT_TEXT) 'Creo el datasources
            oCombo = coForm.Items.Item("15").Specific  'identifico mi combobox
            oCombo.DataBind.SetBound(True, "", "dsDrivers")   ' uno mi userdatasources a mi combobox

            loDS = coForm.DataSources.UserDataSources.Add("dsUsers", SAPbouiCOM.BoDataType.dt_SHORT_TEXT) 'Creo el datasources
            loText = coForm.Items.Item("4").Specific  'identifico mi caja de texto
            loText.DataBind.SetBound(True, "", "dsUsers")   ' uno mi userdatasources a mi caja de texto

            loDS = coForm.DataSources.UserDataSources.Add("dsTrucks", SAPbouiCOM.BoDataType.dt_SHORT_TEXT) 'Creo el datasources
            loText = coForm.Items.Item("5").Specific  'identifico mi caja de texto
            loText.DataBind.SetBound(True, "", "dsTrucks")   ' uno mi userdatasources a mi caja de texto

            loDS = coForm.DataSources.UserDataSources.Add("dsDocNs", SAPbouiCOM.BoDataType.dt_SHORT_TEXT) 'Creo el datasources
            loText = coForm.Items.Item("7").Specific  'identifico mi caja de texto
            loText.DataBind.SetBound(True, "", "dsDocNs")   ' uno mi userdatasources a mi caja de texto

            loDS = coForm.DataSources.UserDataSources.Add("dsDates", SAPbouiCOM.BoDataType.dt_SHORT_TEXT) 'Creo el datasources
            loText = coForm.Items.Item("8").Specific  'identifico mi caja de texto
            loText.DataBind.SetBound(True, "", "dsDates")   ' uno mi userdatasources a mi caja de texto

            oGrid = coForm.Items.Item("11").Specific
            oDataTable = coForm.DataSources.DataTables.Add("Invoicess")
    ...
    Public Function cargarComboChofi()
        ...
        Try
            cargarComboChofi = 0
            '--- referencia de combo 
            oCombo = coForm.Items.Item("15").Specific
            coForm.Freeze(True)
